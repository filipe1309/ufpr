Trabalho 4: (TP2) Visualizeitor

    O objetivo é criar um aplicativo em html/javascript/jquery, que permita a visualização da grade curricular de alunos de qualquer curso. A "prova de conceito" será feita come o curso do BCC.
    Características:
    ...
    Data e forma de Entrega: email enviado até 28/04/2014 indicando a url onde o trabalho está localizado. 